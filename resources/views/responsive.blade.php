...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4">
                <img src="https://www.danantaraindonesia.co.id/_next/image?url=%2Fimg%2Fcommon%2Fimg_logo-anniversary-dark.webp&w=384&q=75"
                    alt="Logo Danantara" height="50px">
            </div>
            <div class="col-2 d-flex justify-content-center align-items-center">
                <div>Tentang Kami</div>
            </div>
            <div class="col-2 d-flex justify-content-center align-items-center">
                <div>Ekosistem Kami</div>
            </div>
            <div class="col-2 d-flex justify-content-center align-items-center">
                <div>Hubungan Investor</div>
            </div>
            <div class="col-2 d-flex justify-content-center align-items-center">
                <div>Tata Kelola Perusahaan</div>
            </div>
            <div class="col-1">
                <div></div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-9">
                <p></p>
                <p class="open open-sans-judul fontintro">
                    <b>Danantara Indonesia</b> merupakan badan pengelola investasi yang
                    menangani, mengoptimalkan, dan mengembangkan aset strategis Indonesia, sejalan dengan agenda jangka
                    panjang transformasiekonomi nasional.
                </p>
            </div>
            <div class="col-3">
                <div class="row">
                    <div class="col">
                        <img src="https://www.danantaraindonesia.co.id/_next/image?url=https%3A%2F%2Fd19ypesdspgr78.cloudfront.net%2F490%2FHome_Intro_Small_Image.webp&w=1920&q=75"
                            alt="Foto danantara" class="rounded img-fluid">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <p><a href="https://www.danantaraindonesia.co.id/id/about">Pelajari Lebih Lanjut</a></p>
                    </div>
                </div>
